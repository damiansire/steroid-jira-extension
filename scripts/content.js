...
window.onload = function() {
    // Obtener todos los elementos de encabezado de columna
    const columnHeaders = document.querySelectorAll('h2.__board-test-hook__column-title');
    // Iterar sobre cada encabezado
    columnHeaders.forEach(header => {
      // Crear un nuevo botón
      const linkButton = document.createElement('button');
      linkButton.innerHTML = `
      <svg fill="#000000" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 72 72" enable-background="new 0 0 72 72" xml:space="preserve">
      <g>
        <g>
      ...
      // Agregar un event listener para la funcionalidad del enlace (opcional)
      linkButton.addEventListener('click', () => {
        // Aquí puedes agregar la lógica para abrir el enlace
        // Por ejemplo, window.open('https://www.example.com');
      });
  
      // Insertar el botón después del encabezado
      header.parentNode.insertBefore(linkButton, header.nextSibling);
    });
  };